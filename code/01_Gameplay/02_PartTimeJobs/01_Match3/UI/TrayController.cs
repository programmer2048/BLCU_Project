...
public class TrayController : MonoBehaviour
{
    ...
    public void AddProgress(int amount)
    {
        ...
        for (int i = 1; i <= amount; i++)
        {
            ...
            pos.y += UnityEngine.Random.Range(-50f, 0);
    ...
    System.Collections.IEnumerator CompleteRoutine()
    {
        ...
        {
            // 4. 只有当 "$" 飞到目的地后，才真正加分
            M3_GameManager.Instance.AddScore(requiredCount);
        });
    ...
    void OnTrayFailed()
    {
        ...
        FX_Manager.Instance.PlayFloatingText(M3_GameManager.Instance.patienceHintText.position, $"-{requiredCount-currentCount}");
        Destroy(gameObject);
    }
